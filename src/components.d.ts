...
declare namespace LocalJSX {
  interface GithubCard extends JSXBase.HTMLAttributes<HTMLGithubCardElement> {
    'login'?: string;
  }
  interface GithubCardSelector extends JSXBase.HTMLAttributes<HTMLGithubCardSelectorElement> {}
